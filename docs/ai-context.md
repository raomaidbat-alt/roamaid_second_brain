...
<li>
<p>
    <strong>Генерация каруселей</strong> (`/root/skills/carousel_generator/`): Gemini генерирует текст слайдов, Playwright рендерит HTML в PNG (требуется установка Chromium). Поддержка форматов: Threads 4:5, Instagram 1:1, Stories 9:16.
</p>
</li>
<li>
<p>
    <strong>Публикация в Threads с одобрением:</strong> Внедрить обязательное одобрение хозяином через Telegram для любой публикации в Threads (включая карусели).
</p>
</li>
</ol>
