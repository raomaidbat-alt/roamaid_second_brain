...
*   **Скиллы:** Анализ роликов (`/root/skills/analyze_reel/`), генерация тредов (`/root/skills/generate_thread/`), полный аудит Instagram (`/root/skills/audit_account/`), аудит сайтов (`/root/skills/audit_website/`), обучение из YouTube видео (`/learn`), анализ вирусных тредов (`/root/skills/analyze_threads/` ✅), публикация в Threads (`/root/skills/post_to_threads/` ✅).
