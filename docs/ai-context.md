...
1.  **Генерация каруселей** (`/root/skills/carousel_generator/`): Gemini генерирует текст слайдов. Playwright рендерит HTML в PNG (требует установки Chromium). Поддержка форматов: Threads (4:5), Instagram (1:1), Stories (9:16).
