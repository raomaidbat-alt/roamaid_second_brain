...
DAILY_LOG = BASE_DIR / 'data' / 'daily_log.md'
BRAIN_DIR = BASE_DIR / 'data' / 'brain'
POSTS_DATA = BASE_DIR / 'posts_data.json'
CONTACTS_FILE = BASE_DIR / 'data' / 'contacts.json'
FUNNELS_FILE = BASE_DIR / 'data' / 'funnel_analyses.json'
...
# Vercel imports `app` from this module. Local debug:
if __name__ == '__main__':
    uvicorn.run(app, host='0.0.0.0', port=int(os.getenv('PORT', '8080')), reload=False, log_level='info')
